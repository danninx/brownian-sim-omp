...
echo ""
echo "Running serial..."
./bin/brownian_serial 10000 1.0 0.001 100.0 > serial.csv
echo ""
echo "Running single-process multithreaded..."
./bin/brownian_omp 10000 1.0 0.001 100.0 > multithreaded.csv
echo ""
echo "Running single threaded MPI..."
./bin/brownian_mpi 10000 1.0 0.001 100.0 > mpi.csv
echo ""
echo "Running multithreaded MPI..."
./bin/brownian_mpi_omp 10000 1.0 0.001 100.0 > mpi_omp.csv
